...
<body class="bg-[#f8f5f0] text-[#2e2b26] font-sans">
  ...
  <section class="flex flex-col md:flex-row items-center justify-between px-10 md:px-20 py-20">
    ...
    <div class="md:w-1/2 mt-10 md:mt-0">
      <img src="{{ asset('images/3bags.png') }}"
           alt="Luxury bag" class="">
    </div>
  </section>
  ...
  <section id="shop" class="px-10 md:px-20 py-14 bg-[#f4ede4]">
    ...
    <div class="grid md:grid-cols-3 gap-8">
      ...
      <div class="bg-white p-5 rounded-2xl shadow hover:shadow-lg transition">
        <img src="{{ asset('images/Screenshot 2025-10-22 014139.png') }}"
             alt="Bag 1" class="rounded-xl mb-4">
        <h4 class="font-semibold text-lg">Classic Leather Tote</h4>
        <p class="text-[#5a5245] mt-1 mb-3">$89.99</p>
        <button class="bg-[#a58c63] text-white px-4 py-2 rounded-xl hover:bg-[#8d7753] transition">
          Add to Cart
        </button>
      </div>

      <div class="bg-white p-5 rounded-2xl shadow hover:shadow-lg transition">
        <img src="{{ asset('images/Screenshot 2025-10-22 014433.png') }}"
             alt="Bag 2" class="rounded-xl mb-4">
      ...
      <div class="bg-white p-5 rounded-2xl shadow hover:shadow-lg transition">
        <img src="{{ asset('images/tote-bags-fall-2022-back-to-work-habituallychic-004.jpeg') }}"
             alt="Bag 3" class="rounded-xl mb-4">
